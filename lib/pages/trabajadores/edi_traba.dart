...
class ModalEditarTraba extends StatefulWidget {
  @override
  _ModalEditarTrabaState createState() => _ModalEditarTrabaState();
}

class _ModalEditarTrabaState extends State<ModalEditarTraba> {
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {},
                  style: ElevatedButton.styleFrom(
                    primary: Color.fromARGB(255, 10, 102, 30),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(8),
                    ),
                  ),
